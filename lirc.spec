...
%fdupes -s %{buildroot}
%fdupes -s .
find  %{buildroot}%{_libdir}   -type d -name "__pycache__" -exec rm -rv {} +
...
- init from openSUSE
  author: openSUSE
  url: https://build.opensuse.org/package/view_file/openSUSE:Factory:RISCV/lirc
  changes: https://build.opensuse.org/package/view_file/openSUSE:Factory:RISCV/lirc/lirc.changes
- remove unresolvable requires libirman 
- remove pyc from the python library runtime cache 
- modfiy BuildRequires for openEuler
